...
<form id="form1" name="form1" method="post" action="">
  <table width="1300" height="184" border="1">
    ...
    <?php
    $i="";
    $selquery="select * from tbl_seller s inner join tbl_place p inner join tbl_district d on s.place_id=p.place_id and p.district_id=d.district_id where seller_status = 0";
