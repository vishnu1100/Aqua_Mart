...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Booking Details</h1>
        <br><br>
        ...
        <tbody>
            ...
            session_start();
            $i = 0;
            // Query to fetch product details along with category and seller information
            $selQry = "
                SELECT * 
                FROM   tbl_booking b inner join tbl_cart ct on b.booking_id = ct.booking_id inner join  tbl_product p  on p.product_id = ct.product_id
                INNER JOIN tbl_category c ON p.Cat_id = c.Cat_id
                INNER JOIN tbl_seller s ON p.seller_id = s.seller_id where s.seller_id = ".$_SESSION['sid'];
            ...
            <tr>
                ...
                <td>
                    <a href="../Assets/Files/ProductPhotos/<?php echo $row['product_photo']; ?>" target="_blank">
                        <img src="../Assets/Files/ProductPhotos/<?php echo $row['product_photo']; ?>" height="50px" width="50px" />
                    </a>
                </td>
